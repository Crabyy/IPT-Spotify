...
io.on('connection', (socket) => {
    ...
    socket.on('chat message', (msg) => {
        const sender = socket.user ? socket.user.username : 'Anonymous'; // Default sender if not authenticated
...
const CLIENT_ID = '6acd272b124d41aa96555fa119c83110';
const CLIENT_SECRET = '0886a18f5fc7476c98db339269dd2390';
